...
function Task({ title, descriptions, dateStart, dateEnd }: TaskProps) {
	return (
		<div className={styles.task__container}>
			...
			<div className={styles.task__description__wrapp}>
				<h3 className={styles.task__description__title}>Описание:</h3>
				<button className={styles.task__descriptions__button}>
			...
			<p className={styles.task__descriptions__text}>{descriptions}</p>
			<p className={styles.task__date}>{`${dateStart} - ${dateEnd}`}</p>
		</div>
	)
}
